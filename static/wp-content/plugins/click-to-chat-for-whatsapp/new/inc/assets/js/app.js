! function(t) {
    t((function() {
        ...
        function m(t) {
            var e;
            "yes" == n ? "show" == s.dis_m && ((e = document.querySelector(".ht_ctc_desktop_chat")) && e.remove(), t.style.cssText = s.pos_m + s.css, p(t)) : "show" == s.dis_d && ((e = document.querySelector(".ht_ctc_mobile_chat")) && e.remove(), t.style.cssText = s.pos_d + s.css, p(t))
        }
            ...
            if ("" != o) {
                ...
                window.open(h, d, l), s.chat_number = o,
                    function(t) {
                        ...
                        var a = s.chat_number && "" !== s.chat_number ? s.chat_number : s.number,
                            _ = {},
                            o = "Click to Chat for WhatsApp",
                            i = "chat: " + a,
                            r = c + ", " + e;
                        if (s.ga) {
                            var h = s.g_an_event_name && "" !== s.g_an_event_name ? s.g_an_event_name : "click to chat";
                            h = n(h), u.g_an_params && u.g_an_params.forEach((t => {
                                if (u[t]) {
                                    var e = u[t],
                                        c = e.key,
                                        a = e.value;
                            ...
                            if ("undefined" != typeof dataLayer) try {
                                ...
                                function m(t) {
                                    t = t.toUpperCase(), g.includes(t) || (g.push(t), (t.startsWith("G-") || t.startsWith("GT-")) && (_.send_to = t, gtag("event", h, _), d++))
                                }
                                if (window.google_tag_data && window.google_tag_data.tidr && window.google_tag_data.tidr.destination)
                                    for (var p in window.google_tag_data.tidr.destination) m(p);
                                dataLayer.forEach((function(t) {
                                    "config" == t[0] && t[1] && m(p = t[1])
                                }))
                            } catch (b) {}
                            0 == d && "no" == l && ("undefined" != typeof gtag ? gtag("event", h, _) : "undefined" != typeof ga && void 0 !== ga.getAll ? ga.getAll()[0].send("event", o, i, r) : "undefined" != typeof __gaTracker && __gaTracker("send", "event", o, i, r))
                        }
                        if ("undefined" != typeof dataLayer && dataLayer.push({
                            ...
                            var v = s.pixel_event_name && "" !== s.pixel_event_name ? s.pixel_event_name : "Click to Chat by HoliThemes",
                                f = u.pixel_event_type && "" !== u.pixel_event_type ? u.pixel_event_type : "trackCustom",
                                y = {};
                            u.pixel_params && u.pixel_params.forEach((t => {
                                if (u[t]) {
                                    var e = u[t],
                                        c = e.key,
                                        a = e.value;
        ...
        "undefined" != typeof ht_ctc_variables ? u = ht_ctc_variables : (u = {
            ...
            function() {
                ...
                t("#ctc_opt").is(":checked") && (t(".ctc_opt_in").hide(100), r("g_optin", "y"), setTimeout((() => {
                    y(h), l()
                }), 500))
